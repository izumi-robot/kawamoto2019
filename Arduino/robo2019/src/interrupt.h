...
template<int in_pin, int mode> void robo::Interrupt<in_pin, mode>::callback()
{
    _state = !_state;
}

template<int in_pin, int mode> void robo::Interrupt<in_pin, mode>::setup()
{
    _state = false;
...
template<int in_pin, int mode> bool robo::Interrupt<in_pin, mode>::state()
{
    return _state;
}

template<int in_pin, int mode> bool robo::Interrupt<in_pin, mode>::changed()
{
